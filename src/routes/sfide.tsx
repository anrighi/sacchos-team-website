  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-10">
      ...
      <p className="mt-4 max-w-lg text-white/70">
        I tabellini finiti finiscono su Cloudflare KV: chi ha giocato, chi ha
        vinto, formazioni e log eventi.
      </p>
      <p className="mt-8 rounded-sm border border-white/10 bg-navy px-4 py-6 text-sm text-white/60">
        Nessuna sfida archiviata. Finché F6 non è pronto lo storico resta
        vuoto, i link delle partite continuano a funzionare.
      </p>
    </main>
  );
}
