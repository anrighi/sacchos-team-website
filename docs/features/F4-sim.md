...
| Status | done |
| Phase | 2 |
| Files | `src/lib/challenge/sim.ts`, `src/lib/challenge/board.ts`, `src/lib/challenge/efficiency.ts`, `src/components/challenge/MatchView.tsx`, `src/components/challenge/MatchBoard.tsx`, `src/components/challenge/AnalogClock.tsx`, `src/routes/sfida.tsx` |
