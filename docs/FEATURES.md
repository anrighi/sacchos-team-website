...
|------|-------|-------|------|-----------|---------|
| 2026-09-19 | Cursor | 2 | F4: tavolo Subbuteo 2D in match (`board.ts` + `MatchBoard`, pose da eventi, casa in basso) | F5: tabellino `/sfida/partita` con OG e share; stack su F4 | Ruoli/stat del seed ancora vuoti (tutti 75) |
