...
|------|-------|-------|------|-----------|---------|
| 2026-09-19 | Cursor | 2 | F4: impedisce la meta cita il tiratore; efficienza (mete/tiri) in localStorage | F5: tabellino `/sfida/partita` con OG e share; stack su F4 | Ruoli/stat del seed ancora vuoti (tutti 75); F6 Sheet per lo store |
